...
SECRET_KEY = 'django-insecure-v+-+uw+stvc+cvf8=vu(u-&l%mrkdfwp@bw(4gt@5dm3m(quo3'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['codenexuspro-1fbu.onrender.com','127.0.0.1','localhost']
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'srgipbca@gmail.com'
EMAIL_HOST_PASSWORD = 'wyerrxbkorexsked' 
